...
#include <mmsystem.h> // playsound 함수 사용을 하기위한 헤더파일
#pragma comment (lib, "winmm.lib") // pragma 전처리 지시자. 컴파일 방법을 바꿀때 사용됨.
...
void main_printer()
{
	...
	int cnt = 0; // 카운트 용도
	unsigned int event_select; // 선택용 인수를 담을 변수
